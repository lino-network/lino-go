...
func (broadcast *Broadcast) Transfer(ctx context.Context, sender, receiver, amount, memo, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) Follow(ctx context.Context, follower, followee, privKeyHex string, seq int64) error {
	msg := model.FollowMsg{
		Follower: follower,
		Followee: followee,
	}
...
func (broadcast *Broadcast) Unfollow(ctx context.Context, follower, followee, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) Claim(ctx context.Context, username, privKeyHex string, seq int64) error {
	msg := model.ClaimMsg{
		Username: username,
	}
	return broadcast.broadcastTransaction(ctx, msg, privKeyHex, seq, "")
...
func (broadcast *Broadcast) UpdateAccount(ctx context.Context, username, jsonMeta, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) Recover(ctx context.Context, username, newResetPubKeyHex,
	newTransactionPubKeyHex, newAppPubKeyHex, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) CreatePost(ctx context.Context, author, postID, title, content, parentAuthor, parentPostID,
...
func (broadcast *Broadcast) Donate(ctx context.Context, username, author,
	amount, postID, fromApp, memo string, privKeyHex string, seq int64) error {
	msg := model.DonateMsg{
		Username: username,
		Amount:   amount,
		Author:   author,
...
func (broadcast *Broadcast) ReportOrUpvote(ctx context.Context, username, author,
	postID string, isReport bool, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) DeletePost(ctx context.Context, author, postID, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) View(ctx context.Context, username, author, postID, privKeyHex string, seq int64) error {
	msg := model.ViewMsg{
		Username: username,
		Author:   author,
		PostID:   postID,
...
func (broadcast *Broadcast) UpdatePost(ctx context.Context, author, title, postID,
...
func (broadcast *Broadcast) ValidatorDeposit(ctx context.Context, username, deposit,
	validatorPubKey, link, privKeyHex string, seq int64) error {
...
// It composes ValidatorDepositMsg and then broadcasts the transaction to blockchain.
func (broadcast *Broadcast) ValidatorWithdraw(ctx context.Context, username, amount, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) ValidatorRevoke(ctx context.Context, username, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) VoterDeposit(ctx context.Context, username, deposit, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) VoterWithdraw(ctx context.Context, username, amount, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) VoterRevoke(ctx context.Context, username, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) Delegate(ctx context.Context, delegator, voter, amount, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) DelegatorWithdraw(ctx context.Context, delegator, voter, amount, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) RevokeDelegation(ctx context.Context, delegator, voter, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) DeveloperRevoke(ctx context.Context, username, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) GrantPermission(ctx context.Context, username, authorizedApp string,
	validityPeriodSec int64, grantLevel model.Permission, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) PreAuthorizationPermission(ctx context.Context, username, authorizedApp string,
	validityPeriodSec int64, amount string, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) RevokePermission(ctx context.Context, username, pubKeyHex string,
	privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) ChangeEvaluateOfContentValueParam(ctx context.Context, creator string,
	parameter model.EvaluateOfContentValueParam, reason string, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) ChangeGlobalAllocationParam(ctx context.Context, creator string,
	parameter model.GlobalAllocationParam, reason string, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) ChangeInfraInternalAllocationParam(ctx context.Context, creator string,
	parameter model.InfraInternalAllocationParam, reason string, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) ChangeVoteParam(ctx context.Context, creator string,
	parameter model.VoteParam, reason string, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) ChangeProposalParam(ctx context.Context, creator string,
	parameter model.ProposalParam, reason string, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) ChangeDeveloperParam(ctx context.Context, creator string,
	parameter model.DeveloperParam, reason string, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) ChangeValidatorParam(ctx context.Context, creator string,
	parameter model.ValidatorParam, reason string, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) ChangeBandwidthParam(ctx context.Context, creator string,
	parameter model.BandwidthParam, reason string, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) ChangeAccountParam(ctx context.Context, creator string,
	parameter model.AccountParam, reason string, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) ChangePostParam(ctx context.Context, creator string,
	parameter model.PostParam, reason string, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) DeletePostContent(ctx context.Context, creator, postAuthor,
	postID, reason, privKeyHex string, seq int64) error {
...
func (broadcast *Broadcast) VoteProposal(ctx context.Context, voter, proposalID string,
	result bool, privKeyHex string, seq int64) error {
...
//
func (broadcast *Broadcast) broadcastTransaction(ctx context.Context, msg model.Msg, privKeyHex string, seq int64, memo string) error {
	res, err := broadcast.transport.SignBuildBroadcast(ctx, msg, privKeyHex, seq, memo)
	if err != nil {
		return err
	}

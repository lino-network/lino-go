...
func setup(t *testing.T) *api.API {
	return api.NewLinoAPIFromArgs(chainID, nodeURL)
}
...
func TestAccount(t *testing.T) {
	...
	_, err = testAPI.GetGrantList("lino")
	if err != nil {
		t.Errorf("TestAccount: failed to get grant list: %v", err)
	}
